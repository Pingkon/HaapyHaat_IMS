...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-4">
                <label for="example-text-input" class="col-sm-2 col-form-label">Farmer Name</label>
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Farmer Mobile</label>
                <div class="form-group col-sm-10">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Farmer Email</label>
                <div class="form-group col-sm-10">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Farmer Address</label>
                <div class="form-group col-sm-10">
